...
<div class="card shadow-sm mb-3">
  <div class="card-body">
    ...
    <div class="alert alert-info py-2 px-3 small mb-3" role="alert">
      ...
      ส่วน <strong>ผู้ร่วมดำเนินงานทุกคน</strong> (หัวหน้าโครงการ ผู้ร่วมวิจัย ที่ปรึกษา ฯลฯ พร้อมสัดส่วน %)
      ให้เพิ่มในหน้า "รายละเอียดโครงการ" หลังบันทึก
    </div>
    ...
    <div class="row g-3">
      ...
      <div class="col-12 col-md-4">
        ...
        ->dropDownList($userItems, [
          'prompt' => 'เลือกผู้บันทึก/เจ้าของเรื่อง..'
        ])
        ->hint('คนที่รับผิดชอบและเป็นเจ้าของรายการในระบบ (ผู้ร่วมโครงการเพิ่มได้ภายหลัง)') ?>
      </div>
    </div>
