...
<div class="account-form">
    ...
    <div class="row">
        <div class="card col">
            ...
            <div class="card-body login-card-body">
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <?= $form->field($model, 'prefix')->radioList([
                            '1' => 'ชาย',
                            '2' => 'หญิง'
                        ]); ?>
                    </div>
                ...
                <?php if ($identity && ($identity->position == 4 || $identity->uid == $model->uid)) : ?>
                    <div class="card mt-3">
                        <div class="card-header bg-danger">
                            <p style="margin-top: 12px" class="h-card">ตั้งชื่อผู้ใช้และรหัสผ่าน</p>
                        </div>
                        <div class="card-body">
                            <div class="col">
        ...
        <?= $form->field($model, 'password_reset_token')
            ->hiddenInput(['value' => 'rdi00reset00token', 'readonly' => true])
            ->label(false) ?>
        <?= $form->field($model, 'authKey')
            ->hiddenInput(['value' => 'rdi', 'readonly' => true])
            ->label(false) ?>
    </div>
    ...
    <div class="row">
        <div class="col d-flex justify-content-center">
            <?= Html::submitButton('<i class="fa fa-save"></i> ลงทะเบียน', [
