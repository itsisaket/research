...
$formModel->role_code_form = 'member';
...
// ใช้ returnUrl กลับหน้าปัจจุบัน
        ...
        <div class="d-flex justify-content-between align-items-center gap-2">
          ...
          <?php if (!empty($isOwner)): ?>
            <div class="d-flex align-items-center gap-2 flex-shrink-0">
              ...
              <form method="post"
                    action="<?= Url::to(['/work-contributor/update-pct', 'wc_id' => $c->wc_id, 'returnUrl' => $returnUrl]) ?>"
              ...
              <?= Html::a('<i class="fas fa-trash-alt"></i>', ['/work-contributor/delete',
                  'wc_id' => $c->wc_id,
                  'returnUrl' => $returnUrl,
              ], [
...
<div class="border rounded p-3 bg-light">
  ...
  <?php $f = ActiveForm::begin([
      'action' => ['/work-contributor/add', 'refType' => $refType, 'refId' => $refId, 'returnUrl' => $returnUrl],
      'method' => 'post',
  ]); ?>
